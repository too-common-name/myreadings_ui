        ...
        <v-container fluid>
          <v-row>
            <v-col cols="12" class="d-flex flex-column align-center">
              ...
              <p
                class="text-body-2 font-weight-bold mb-4 align-self-baseline"
                style="white-space: pre-wrap"
              >
                {{ book.description || 'No description available.' }}
              </p>
              <p class="text-subtitle-2 text-grey-darken-2 mb-1 align-self-baseline">
                Genre: {{ book.genre || 'N/A' }}
              </p>
              <p class="text-subtitle-2 text-grey-darken-2 mb-1 align-self-baseline">
                {{ book.pageCount || 'N/A' }} pages
              </p>
              <p class="text-subtitle-2 text-grey-darken-2 align-self-baseline">
                First published on {{ formattedPublicationDate }}
              </p>
            </v-col>
          </v-row>
        </v-container>
        ...
        <v-container fluid>
          <v-row>
            ...
            <v-col cols="12" md="7">
              ...
              <p class="text-subtitle-2 text-grey-darken-2 mb-1">
                Genre: {{ book.genre || 'N/A' }}
              </p>
              <p class="text-subtitle-2 text-grey-darken-2 mb-1">
                {{ book.pageCount || 'N/A' }} pages
...
const emit = defineEmits(['update:modelValue', 'confirm-changes'])
